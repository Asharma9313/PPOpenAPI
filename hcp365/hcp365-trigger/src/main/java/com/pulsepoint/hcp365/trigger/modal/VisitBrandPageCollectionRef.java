...
@NoArgsConstructor
@Entity
@Table(name = "HCP365Trigger_Action_Visit_Brand_CollectionXRef")
@Audited
@AuditTable(value = "AuditAdvHCP365Trigger_Action_Visit_Brand_CollectionXRef")
@EqualsAndHashCode(callSuper = false)
public class VisitBrandPageCollectionRef {
    @Id
